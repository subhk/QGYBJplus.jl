...
- [Time Stepping](timestepping.md): second-order exponential RK integration
...
│   │
│   ├── ─── Time Integration ───
│   ├── timestep.jl           # Exponential RK2 time integration
│   │
│   ├── ─── Initialization ───
...
| Function | Description |
|:---------|:------------|
| `exp_rk2_step!` | Second-order exponential RK step |
